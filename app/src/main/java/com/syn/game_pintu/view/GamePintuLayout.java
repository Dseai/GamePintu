package com.syn.game_pintu.view;
...
import com.syn.game_pintu.ImagePiece;
import com.syn.game_pintu.ImageSplitterUtil;
import com.syn.game_pintu.R;
...
public class GamePintuLayout extends RelativeLayout implements OnClickListener
{
	...
	public interface GamePintuListener
	{
		...
		void timechanged(int currentTime);//时间改变
...
//设置id
			...
			// 在Item的tag中存储了index   index在最后判断拼图是否成功
